...
class TextEditor:
	...
	def __init__(self, root):
		# Assigning root
		self.root = root
		# Assigning window width
		self.windowWidth = 1200
		# Assigning window height
		self.windowHeight = 800
		# Assigning geometry for the root
		self.root.geometry(str(self.windowWidth)+'x'+str(self.windowHeight))
		# Assigning current sentence
		...
		# List of result 
		self.listResults = []
		# Declare list of sentences variable
		self.listSentencesVar = StringVar(value=self.listSentences)
		# Declare list of results variable
		...
		# --------------------------------------------------------------------------------
		# --------------------------------------------------------------------------------
		# Set color and other properties of the text editor
		self.titlebar = Label(self.root, textvariable=self.title, font=(
			"Roboto", 12, "bold"), background="#e9ecef")  
	...
	# History of the inputted sentences will be appended to sentence area
	...
	# Define function to empty entry box when "Enter" or "Run" button is hit
	def clear_entry_text(self):
		self.sentenceInputBox.delete(0, END)

	# Define function to pass the written algorithm to process input sentence
	...
	# Define a function to append the result to results area after proccessing the algorithm
	def append_to_ResultsArea(self, output):
		self.resultsAreaBox.insert(0, output)

	# Define functions to highlight the history of an input sentence and its corresponding result
	...
	# Define functions to callback when adding observer
