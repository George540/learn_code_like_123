...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Creating Text Area
    self.txtarea = Text(self.root,yscrollcommand=scrol_y.set,font=("Georgia",12),state="normal",relief=GROOVE)
...
# Defining Save File Funtion
  ...
  def infodictionary(self):
    messagebox.showinfo("Reserved Keywords","add...to...\nsubstract...from...\nmultiple...by... \n"+
                        "divide...by... \nif... is even/odd then...\n")
  def infotips(self):
    messagebox.showinfo("Tips for Success","Make sure you use integers for if statements")
